...
('arwhite6','053-87-1120','1960-06-06','Amelia-Rose','Whitehead','2021-12-03','60 
Nightshade Court','Baltimore','MD','21217'),
('ealfaro4','278-78-7676','1960-06-06','Evie','Alfaro','2021-12-27','314 Five 
Fingers Way','Atlanta','GA','30301'),
('mmcgill4','623-09-0887','1955-06-23','Maheen','McGill','2020-09-08','741 Pan 
American Trace','East Cobb','GA','30304'),
('sville19','354-10-6263','1965-03-16','Sahar','Villegas','2020-06-16','10 Downing 
Road','East Cobb','GA','30304'),
('rnairn5','404-51-1036','1959-07-13','Roxanne','Nairn','2021-08-16','2048 
Transparency Road','Atlanta','GA','30301'),
('smcgill17','238-40-5070','1954-06-02','Saqlain','McGill','2020-09-11','741 Pan 
American Trace','East Cobb','GA','30304'),
('tjtalbot4','203-46-3005','1978-05-10','TJ','Talbot','2020-03-25','101 Snoopy 
Woodstock Circle','Salt Lake City','UT','84108'),
('owalter6','346-51-9139','1971-10-23','Om','Walter','2020-04-29','143 Snoopy 
Woodstock Circle','Salt Lake City','UT','84108'),
('rsanchez','012-34-5678','1936-08-22','Rick','Sanchez',null,'137 Puget 
Run','Seattle','WA','98420'),
('msmith','246-80-1234','1999-04-04','Morty','Smith','2017-08-21','137 Puget 
Run','Seattle','WA','98420'),
('lgibbs4','304-39-1098','1954-11-21','Leroy','Gibbs','2021-06-16','50 Mountain 
Spur','Stillwater','PA','17878'),
('ghopper9','101-00-1111','1906-12-09','Grace','Hopper','2019-12-25','1 
Broadway','New York','NY','10004'),
('asantiago99','765-43-2109','1983-07-04','Amy','Santiago','2018-03-09','1477 Park 
Avenue Apt. 82','New York','NY','11217'),
('rholt99','111-22-3333','1955-01-01','Raymond','Holt','2022-01-01','123 Main 
Street','Perth Amboy','NJ','08861'),
('jperalta99','775-33-6054','1981-09-04','Jake','Peralta','2018-03-09','1477 Park 
Avenue Apt. 82','New York','NY','11217'),
('glinetti99','233-76-0019','1986-03-20','Gina','Linetti','2019-04-04','75 Allure 
Drive','New York','NY','11220'),
('cboyle99','433-12-1200','1982-09-04','Charles','Boyle','2018-03-10','1477 Park 
Avenue Apt. 65','New York','NY','11217'),
('rdiaz99','687-54-1033','1984-11-30','Rosa','Diaz','2020-12-24','3 East Park 
Loop','Yonkers','NY','10112'),
('atrebek1','000-00-0000','1940-07-22','Alex','Trebek','2014-03-22','10202 West 
Washington Boulevard','Culver City','CA','90232'),
('kjennings66','004-52-2700','1974-05-23','Ken','Jennings','2005-09-07','74 
Champions Heights','Edmonds','WA','98020'),
...
('beyonce','444-55-666','1981-09-04','Beyonce',null,'2014-02-02','222 Star 
Grove','Houston','TX','77077');
...
('WF_1','Wells Fargo #1 Bank','1010 Binary 
Way','Seattle','WA','98101',127000,'WF','sville19'),
('WF_2','Wells Fargo #2 Bank','337 Firefly 
Lane','Seattle','WA','98101',553000,'WF','mmcgill4'),
('BA_West','Bank of America West Region Bank','865 Black Gold 
Circle','Dallas','TX','75116',267000,'BA','smcgill17'),
('NASA_Goddard','NASA FCU at Goddard SFC','8800 Greenbelt 
Road','Greenbelt','MD','20771',140000,'NASA','rsanchez'),
('TD_Online',null,null,null,null,null,0,'TD','kjennings66'),
('TD_GT','TD Ameritrade Midtown Branch','47 Tech 
Parkway','Atlanta','GA','30333',null,'TD','gburdell'),
('NASA_KSC','NASA FCU at Kennedy Space Center','1 Space Commerce Way','Cape 
Canaveral','FL','45678',0,'NASA','rholt99'),
('BA_South','Bank of America Plaza-Midtown','600 Peachtree Street 
NE','Atlanta','GA','30333',42000,'BA','ghopper9'),
('NASA_HAL','NASA FCU at US Space & Rocket Center','1 Tranquility Base Suite 
203','Huntsville','AL','35805',null,'NASA','pbeesly17');
...
accountID varchar(100),
    ...
    primary key (bankID, accountID),
    constraint fk8 foreign key (bankID, accountID) references bank_account(bankID, 
accountID)
) engine=innodb;
...
bankID varchar(100),
    ...
    constraint fk9 foreign key (bankID, accountID) references 
interest_bearing(bankID, accountID)
) engine=innodb;
...
bankID varchar(100),
    ...
    primary key (bankID, accountID),
    constraint fk10 foreign key (bankID, accountID) references 
interest_bearing(bankID, accountID)
) engine=innodb;
...
bankID varchar(100),
    ...
    primary key (bankID, accountID),
    constraint fk11 foreign key (bankID, accountID) references 
interest_bearing(bankID, accountID)
) engine=innodb;
...
bankID varchar(100),
    ...
    constraint fk7 foreign key (bankID, accountID) references bank_account(bankID, 
accountID),
    constraint fk18 foreign key (protectionBank, protectionAccount) references 
savings(bankID, accountID)
) engine=innodb;
...
constraint fk16 foreign key (perID) references customer(perID),
    constraint fk17 foreign key (bankID, accountID) references bank_account(bankID,
accountID)
) engine=innodb;
